...
The official adapters currently target Cloudflare Pages, GitHub Pages, Netlify, and Vercel. The [Adapter reference](../04-reference/04-adapters.md) documents their installation, options, generated files, and platform limitations.
