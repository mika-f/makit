...
```ts
import { defineConfig } from "makit";
import cloudflarePages from "@makit/adapter-cloudflare-pages";
...
```ts
import { defineConfig } from "makit";
import githubPages from "@makit/adapter-github-pages";
...
```ts
import { defineConfig } from "makit";
import netlify from "@makit/adapter-netlify";
...
```ts
import { defineConfig } from "makit";
import vercel from "@makit/adapter-vercel";
...
} from "@makit/adapter-cloudflare-pages";
```
...
```text
✓ Deployment adapter: @makit/adapter-cloudflare-pages
...
```text
✓ Deployment adapter: @makit/adapter-github-pages
...
```text
✓ Deployment adapter: @makit/adapter-netlify
...
```text
✓ Deployment adapter: @makit/adapter-vercel
