...
export function globalsCssTemplate(options: GlobalsCssOptions): string {
  const lines = [
    ...
    "}",
    "",
    ".makit-prose .makit-table-wrapper {",
    "  overflow-x: auto;",
    ...
    "  --makit-alert-color: var(--makit-color-accent);",
    "  margin-block: 1.5rem;",
    "  border: 1px solid color-mix(in srgb, var(--makit-alert-color) 28%, var(--makit-color-border));",
    "  border-left: 0.25rem solid var(--makit-alert-color);",
    "  border-radius: 0;",
    "  background: color-mix(in srgb, var(--makit-alert-color) 7%, var(--makit-color-surface));",
    "  padding: 1rem 1.125rem;",
    "  color: var(--makit-color-foreground);",
    "}",
    "",
    ".makit-prose .makit-alert-note { --makit-alert-color: #0969da; }",
    ".makit-prose .makit-alert-tip { --makit-alert-color: #1a7f37; }",
    ".makit-prose .makit-alert-important { --makit-alert-color: #8250df; }",
    ".makit-prose .makit-alert-warning { --makit-alert-color: #9a6700; }",
    ".makit-prose .makit-alert-caution { --makit-alert-color: #cf222e; }",
    "",
    ".makit-prose .makit-alert-title {",
    "  margin: 0 0 0.35rem;",
    "  color: var(--makit-alert-color);",
    "  font-size: 0.78rem;",
    "  font-weight: 700;",
    ...
    "}",
    "",
    ".makit-prose .makit-alert > :last-child { margin-bottom: 0; }",
    "",
    ...
    "}",
    "",
    ".makit-prose .makit-external-link-icon {",
    ...
    "}",
    "",
    "pre.shiki.has-line-numbers .line {",
    "  display: inline-block;",
    "  min-width: 100%;",
    "}",
    "",
    ...
    "  display: inline-block;",
    "  min-width: 100%;",
    "  background: color-mix(in srgb, var(--makit-color-accent) 14%, transparent);",
    "}",
    "",
